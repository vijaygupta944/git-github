...
This repository is created to **practice Git & GitHub hands-on**, exactly the way they are used in **real corporate projects**.

> This is **not theory or notes**.  
> Every concept here has been **executed practically** using local repositories, branches, commits, merges, rebases, and GitHub pushes.
...
- Initialized repo using `git init`
- Configured Git identity (`user.name`, `user.email`)
- Used **Git Graph extension** to visualize commits
- Created initial commit using `README.md` (industry standard)
